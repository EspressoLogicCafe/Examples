(function () {
    ...
    // This will only define 1 object schema type used by the LAC Audit service for Mock purposes

    log.info("DSP:Mock - structure begin");
    ...
    if (log.isDebugEnabled()) {
        log.debug("DSP:mock - structure result: " + JSON.stringify(structure));
    }

    structure.tables.add(entity);
    log.info("DSP:mock - structure end");
})();
